...
<template>
  <div class="flex min-h-screen flex-col items-center justify-center bg-background text-foreground">
    <div class="relative z-20 text-center">
      <span class="pointer-events-none absolute z-10 -translate-x-1/2 -translate-y-1/2 text-[200px] font-bold text-gray-400/10 dark:text-gray-600/10">
        {{ error.statusCode }}
      </span>
      <div v-if="error.statusCode === 404">
        <h1 class="font-serif text-4xl font-light italic text-foreground">
